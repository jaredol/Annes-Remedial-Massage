...
(function(e) {
    ...
    e.fn.animatescroll = function(t) {
        ...
        if (n.element == "html,body") {
            ...
            e(n.element).stop().animate({scrollTop: r - n.padding - 181}, n.scrollSpeed, n.easing)
        } else {
            //e(n.element).stop().animate({scrollTop: this.offset().top + 400 - this.parent().offset().top + this.parent().scrollTop() - n.padding}, n.scrollSpeed, n.easing)
        }
        setTimeout(function() {
